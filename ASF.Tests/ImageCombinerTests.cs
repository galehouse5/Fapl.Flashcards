...
namespace ASF.Tests
{
    ...
    public class ImageCombinerTests
    {
        ...
        {
            using (Image expectedImage = GetExpectedImage("ASF.Tests.ImageCombiner.one-image-combo.png"))
        ...
        {
            using (Image expectedImage = GetExpectedImage("ASF.Tests.ImageCombiner.two-image-combo.png"))
        ...
        {
            using (Image expectedImage = GetExpectedImage("ASF.Tests.ImageCombiner.three-image-combo.png"))
        ...
        {
            using (Image expectedImage = GetExpectedImage("ASF.Tests.ImageCombiner.four-image-combo.png"))
