...
using FriendshipApl.Flashcards.Shared.Cram;
using FriendshipApl.Flashcards.Shared.ImageLayout;
using FriendshipApl.Flashcards.Shared.Petfinder;
using FriendshipApl.Flashcards.Shared.SyncData;
...
namespace FriendshipApl.Flashcards.AzureFunctions
{
