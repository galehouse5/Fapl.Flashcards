using FriendshipApl.Flashcards.Shared;
using FriendshipApl.Flashcards.Shared.ImageLayout;
...
namespace FriendshipApl.Flashcards.Tests
{
    [TestClass]
    public class ImageCombinerTests
    {
        ...
        {
            using (Image expectedImage = GetExpectedImage("FriendshipApl.Flashcards.Tests.ImageCombiner.one-image-combo.png"))
        ...
        {
            using (Image expectedImage = GetExpectedImage("FriendshipApl.Flashcards.Tests.ImageCombiner.two-image-combo.png"))
        ...
        {
            using (Image expectedImage = GetExpectedImage("FriendshipApl.Flashcards.Tests.ImageCombiner.three-image-combo.png"))
        ...
        {
            using (Image expectedImage = GetExpectedImage("FriendshipApl.Flashcards.Tests.ImageCombiner.four-image-combo.png"))
